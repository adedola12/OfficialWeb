    ...
    >
      ...
      <div className='mx-auto flex flex-col gap-8'>
        <div className='flex items-center justify-between flex-wrap gap-5'>
          <h4 className='font-bold md:text-[54px] text-[44px] text-white'> Get Started With Our Courses</h4>
          <button
            type='button'
        ...
        <div className='flex flex-col'>
          ...
          <div className='flex items-center justify-between flex-wrap gap-4'>
            ...
            <p className='font-normal text-[14px] text-white opacity-50'>Copyright {currentYear} ADLMStudio. All rights reserved.</p>
