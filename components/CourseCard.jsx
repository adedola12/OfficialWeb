...
const CourseCard = ({
  ...
  return (
    <motion.div
      ...
      className={`relative ${active === id ? 'lg:flex-[3.5] flex-[10]' : 'lg:flex-[0.5] flex-[2]'} flex items-center justify-center transition-[flex] duration ease-out-flex cursor-pointer mt-[30px] mb-[30px] h-[700px] w-[720px]`}
      onClick={() => {
